...
6. ALWAYS  summarize in the provided language in options. If the input is in a different language, translate it to the provided language before summarizing.
`;
...
7. ALWAYS summarize in the provided language in options. If the input is in a different language, translate it to the provided language before summarizing.
`;
